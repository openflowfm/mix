...
```sh
npm run dev        # working on it: vite and the window, one command — twice is two of each
...
| the browser tab `npm run dev` also serves, and why it is the real app | [`docs/reach.md`](docs/reach.md) — `src/main.tsx`, `@openflow/desktop/reach-client.ts` |
